...
function IntroductionHome() {
  return (
    <section className="bg-gradient-to-t from-color-base-1 3xl:min-h-[800px] xxxl:min-h-[720px] xxl:min-h-[620px] xlg:min-h-[500px] xl:min-h-[420px] md:h-[400px] xm:min-h-[520px] rounded-[20px] flex xxl:px-20 xl:px-10 mb-26 mt-6">
      <div className="flex flex-col xlg:justify-center xl:justify-center self-center h-5/6 xl:w-7/12 xxl:gap-y-32 md:gap-y-20 gap-y-10 w-full">
        <article className="flex flex-col gap-y-9 text-color-base-8 animeEntryLeftSlow md:px-20 sm:px-10 xm:px-4 xl:px-0">
          <div>
        ...
        <article className="flex flex-col md:flex-row items-start md:gap-x-10 md:gap-y-0 sm:gap-y-5 xm:gap-y-3 animeEntry md:px-20 sm:px-10 xm:px-4 xl:px-0 xl:justify-start justify-between">
          <Link
            href={'/appointments'}
            className="flex content-center xxl:gap-2 xl:gap-1 justify-center bg-color-base-8 xxxl:py-4 xxxl:px-6 sm:px-3 sm:py-2 xm:px-2 xm:py-1 text-color-base-0 rounded-[20px] xxxl:text-xl xl:text-md text-sm font-semibold sm:min-h-[60px] xxxl:h-full xm:w-full md:w-auto"
          >
          ...
          <Link
            ...
            target="_blank"
            className="flex content-center gap-4 justify-center border-2 border-color-base-7 xxxl:py-4 xxxl:px-6 sm:px-3 sm:py-2 xm:px-2 xm:py-1 text-color-base-7 rounded-[20px] xxxl:text-xl xl:text-md text-sm font-semibold sm:min-h-[60px] xxxl:h-full xm:w-full md:w-auto"
          >
